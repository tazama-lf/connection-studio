...
export class AuditInterceptor implements NestInterceptor {
  ...
  intercept(context: ExecutionContext, next: CallHandler): Observable<unknown> {
    ...
    const baseAuditData = this.buildBaseAuditData(
      context,
      request,
      response,
      user,
  ...
  private buildBaseAuditData(
    ...
    return {
      ...
      resourceId:
        this.extractResourceIdFromRequest(request) ??
        this.extractResourceIdFromResponse(response),
