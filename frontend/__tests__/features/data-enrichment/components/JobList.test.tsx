...
jest.mock('../../../../../src/features/data-enrichment/services/dataEnrichmentApi', () => ({
  dataEnrichmentApi: {
    updateStatus: (...args: any[]) => mockUpdateStatus(...args),
    updatePublishingStatus: (...args: any[]) => mockUpdatePublishingStatus(...args),
  },
}));

jest.mock('lucide-react', () => ({
  EyeIcon: (props: any) => <button aria-label="eye" onClick={props.onClick}>eye</button>,
  EditIcon: (props: any) => <button aria-label="edit" onClick={props.onClick}>edit</button>,
  Pause: (props: any) => <button aria-label="pause" onClick={props.onClick}>pause</button>,
  Play: (props: any) => <button aria-label="play" onClick={props.onClick}>play</button>,
  ShieldCheck: (props: any) => <button aria-label="activate" onClick={props.onClick}>activate</button>,
  ShieldX: (props: any) => <button aria-label="deactivate" onClick={props.onClick}>deactivate</button>,
}));
  ...
  return (
    <div data-testid="custom-table">
      ...
      {props.columns.map((column: any) => (
        <div key={`header-${column.field}`} data-testid={`header-${column.field}`}>
...
import { JobList } from '../../../../../src/features/data-enrichment/components/JobList';

const baseProps: any = {
  jobs: [
    { id: '1', endpoint_name: 'Job One', status: 'STATUS_01_IN_PROGRESS', created_at: '2025-01-01T00:00:00Z', type: 'pull', publishing_status: 'in-active' },
  ],
...
describe('features/data-enrichment/components/JobList.tsx', () => {
  ...
  it('renders status/type variations across rows', () => {
    render(
      <JobList
        ...
        isLoading={false}
        jobs={[
          { id: 's1', endpoint_name: 'A', status: 'STATUS_01_IN_PROGRESS', created_at: '2025-01-01T00:00:00Z', type: 'pull', publishing_status: 'in-active' },
          { id: 's2', endpoint_name: 'B', status: 'STATUS_02_ON_HOLD', created_at: '2025-01-01T00:00:00Z', type: 'PUSH', publishing_status: 'active' },
          { id: 's3', endpoint_name: 'C', status: 'STATUS_03_UNDER_REVIEW', created_at: '2025-01-01T00:00:00Z', type: undefined, path: '/push/path', publishing_status: 'in-active' },
          { id: 's4', endpoint_name: 'D', status: 'STATUS_04_APPROVED', created_at: '2025-01-01T00:00:00Z', type: undefined, publishing_status: 'in-active' },
          { id: 's5', endpoint_name: 'E', status: 'STATUS_05_REJECTED', created_at: '2025-01-01T00:00:00Z', type: 'pull', publishing_status: 'in-active' },
          { id: 's6', endpoint_name: 'F', status: 'STATUS_06_EXPORTED', created_at: '2025-01-01T00:00:00Z', type: 'push', publishing_status: 'in-active' },
          { id: 's7', endpoint_name: 'G', status: 'STATUS_07_READY_FOR_DEPLOYMENT', created_at: '2025-01-01T00:00:00Z', type: 'pull', publishing_status: 'in-active' },
          { id: 's8', endpoint_name: 'H', status: 'STATUS_08_DEPLOYED', created_at: '2025-01-01T00:00:00Z', type: 'push', publishing_status: 'in-active' },
          { id: 's9', endpoint_name: 'I', status: 'SUSPENDED', created_at: '2025-01-01T00:00:00Z', type: 'pull', publishing_status: 'in-active' },
          { id: 's10', endpoint_name: 'J', status: 'UNKNOWN_STATUS', created_at: '2025-01-01T00:00:00Z', type: 'pull', publishing_status: 'in-active' },
        ]}
      />,
    );
  ...
  it('opens pause confirmation and updates status for editor', async () => {
    ...
    await waitFor(() => {
      expect(mockUpdateStatus).toHaveBeenCalledWith('1', 'STATUS_02_ON_HOLD', 'PULL');
  ...
  it('opens resume confirmation and updates status for editor', async () => {
    ...
    await waitFor(() => {
      expect(mockUpdateStatus).toHaveBeenCalledWith('2', 'STATUS_01_IN_PROGRESS', 'PULL');
      expect(onRefresh).toHaveBeenCalled();
    });
  });
  ...
  it('opens deactivate confirmation and updates publishing status for approver', async () => {
    ...
    await waitFor(() => {
      expect(mockUpdatePublishingStatus).toHaveBeenCalledWith('1', 'in-active', 'PULL');
      expect(onRefresh).toHaveBeenCalled();
    });
  });
  ...
  it('opens activate confirmation and updates publishing status for publisher', async () => {
    ...
    await waitFor(() => {
      expect(mockUpdatePublishingStatus).toHaveBeenCalledWith('3', 'active', 'PUSH');
      expect(onRefresh).toHaveBeenCalled();
    });
  });
  ...
  it('handles publishing status failure path', async () => {
    mockUseAuth.mockReturnValue({ user: { claims: ['approver'] } });
    mockUpdatePublishingStatus.mockRejectedValueOnce(new Error('publish status failed'));
    ...
    await waitFor(() => {
      expect(mockShowError).toHaveBeenCalledWith('Failed to update publishing status. Please try again.');
    });
  });
  ...
  it('covers additional getStatusBadge color branches', () => {
    render(
      <JobList
        ...
        isLoading={false}
        jobs={[
          { id: 'cr1', endpoint_name: 'CR', status: 'STATUS_05_CHANGES_REQUESTED', created_at: '2025-01-01T00:00:00Z', type: 'pull', publishing_status: 'in-active' },
          { id: 'su1', endpoint_name: 'SU', status: 'STATUS_09_SUSPENDED', created_at: '2025-01-01T00:00:00Z', type: 'pull', publishing_status: 'in-active' },
          { id: 'ap1', endpoint_name: 'AP', status: 'approved', created_at: '2025-01-01T00:00:00Z', type: 'pull', publishing_status: 'in-active' },
          { id: 'ip1', endpoint_name: 'IP', status: 'in_progress', created_at: '2025-01-01T00:00:00Z', type: 'pull', publishing_status: 'in-active' },
          { id: 'cl1', endpoint_name: 'CL', status: 'cloned', created_at: '2025-01-01T00:00:00Z', type: 'pull', publishing_status: 'in-active' },
          { id: 'ur1', endpoint_name: 'UR', status: 'under_review', created_at: '2025-01-01T00:00:00Z', type: 'pull', publishing_status: 'in-active' },
          { id: 'dp1', endpoint_name: 'DP', status: 'deployed', created_at: '2025-01-01T00:00:00Z', type: 'pull', publishing_status: 'in-active' },
          { id: 'cr2', endpoint_name: 'CR2', status: 'changes_requested', created_at: '2025-01-01T00:00:00Z', type: 'pull', publishing_status: 'in-active' },
          { id: 'ex1', endpoint_name: 'EX', status: 'exported', created_at: '2025-01-01T00:00:00Z', type: 'pull', publishing_status: 'in-active' },
          { id: 'rd1', endpoint_name: 'RD', status: 'ready_for_deployment', created_at: '2025-01-01T00:00:00Z', type: 'pull', publishing_status: 'in-active' },
        ] as any}
      />,
    );
  ...
  it('covers null claims path (all role checks default to false)', () => {
    ...
    render(
      <JobList
        ...
        isLoading={false}
        jobs={[
          { id: 'nc1', endpoint_name: 'NC', status: 'STATUS_01_IN_PROGRESS', created_at: '2025-01-01T00:00:00Z', type: 'pull', publishing_status: 'in-active' },
        ]}
      />,
    );
  ...
  it('exporter sees eye icon for approved/exported/deployed jobs', () => {
    ...
    render(
      <JobList
        ...
        onViewLogs={onViewLogs}
        jobs={[
          { id: 'ex1', endpoint_name: 'EX1', status: 'STATUS_04_APPROVED', created_at: '2025-01-01T00:00:00Z', type: 'pull', publishing_status: 'in-active' },
          { id: 'ex2', endpoint_name: 'EX2', status: 'STATUS_06_EXPORTED', created_at: '2025-01-01T00:00:00Z', type: 'pull', publishing_status: 'in-active' },
          { id: 'ex3', endpoint_name: 'EX3', status: 'STATUS_08_DEPLOYED', created_at: '2025-01-01T00:00:00Z', type: 'pull', publishing_status: 'in-active' },
        ]}
      />,
    );
  ...
  it('publisher sees eye icon for exported/approved/deployed jobs', () => {
    ...
    render(
      <JobList
        ...
        onViewLogs={jest.fn()}
        jobs={[
          { id: 'pb1', endpoint_name: 'PB1', status: 'STATUS_06_EXPORTED', created_at: '2025-01-01T00:00:00Z', type: 'pull', publishing_status: 'in-active' },
          { id: 'pb2', endpoint_name: 'PB2', status: 'STATUS_04_APPROVED', created_at: '2025-01-01T00:00:00Z', type: 'pull', publishing_status: 'in-active' },
        ]}
      />,
    );
  ...
  it('activate success without onRefresh prop', async () => {
    ...
    render(
      <JobList
        ...
        onRefresh={undefined}
        jobs={[
          { id: 'nr1', endpoint_name: 'NR', status: 'STATUS_06_EXPORTED', created_at: '2025-01-01T00:00:00Z', type: 'push', publishing_status: 'in-active' },
        ]}
      />,
    );
    fireEvent.click(screen.getByLabelText('activate'));
  ...
  it('covers getStatusBadge lowercase-only branches and STATUS_ prefix <3 parts', () => {
    render(
      <JobList
        ...
        isLoading={false}
        jobs={[
          { id: 'lb1', endpoint_name: 'LB1', status: 'active', created_at: '2025-01-01T00:00:00Z', type: 'pull', publishing_status: 'in-active' },
          { id: 'lb2', endpoint_name: 'LB2', status: 'ready for approval', created_at: '2025-01-01T00:00:00Z', type: 'pull', publishing_status: 'in-active' },
          { id: 'lb3', endpoint_name: 'LB3', status: 'in-progress', created_at: '2025-01-01T00:00:00Z', type: 'pull', publishing_status: 'in-active' },
          { id: 'lb4', endpoint_name: 'LB4', status: 'draft', created_at: '2025-01-01T00:00:00Z', type: 'pull', publishing_status: 'in-active' },
          { id: 'lb5', endpoint_name: 'LB5', status: 'under review', created_at: '2025-01-01T00:00:00Z', type: 'pull', publishing_status: 'in-active' },
          { id: 'lb6', endpoint_name: 'LB6', status: 'changes requested', created_at: '2025-01-01T00:00:00Z', type: 'pull', publishing_status: 'in-active' },
          { id: 'lb7', endpoint_name: 'LB7', status: 'ready for deployment', created_at: '2025-01-01T00:00:00Z', type: 'pull', publishing_status: 'in-active' },
          { id: 'lb8', endpoint_name: 'LB8', status: 'rejected', created_at: '2025-01-01T00:00:00Z', type: 'pull', publishing_status: 'in-active' },
          { id: 'lb9', endpoint_name: 'LB9', status: 'STATUS_solo', created_at: '2025-01-01T00:00:00Z', type: 'pull', publishing_status: 'in-active' },
        ] as any}
      />,
    );
  ...
  it('covers resume dialog onClose via Cancel button (line 676)', async () => {
    render(
      <JobList
        {...baseProps}
        isLoading={false}
        jobs={[{ id: '2', endpoint_name: 'Paused Job', status: 'STATUS_02_ON_HOLD', created_at: '2025-01-01T00:00:00Z', type: 'pull', publishing_status: 'in-active' }]}
      />,
    );
    fireEvent.click(screen.getByLabelText('play'));
  ...
  it('covers activate dialog onClose via Cancel button (line 805)', async () => {
    ...
    render(
      <JobList
        {...baseProps}
        isLoading={false}
        jobs={[{ id: '3', endpoint_name: 'Test Job', status: 'STATUS_06_EXPORTED', created_at: '2025-01-01T00:00:00Z', type: 'push', publishing_status: 'in-active' }]}
      />,
    );
    fireEvent.click(screen.getByLabelText('activate'));
  ...
  it('covers deactivate dialog onClose via Cancel button (line 911)', async () => {
    ...
    render(
      <JobList
        {...baseProps}
        isLoading={false}
        jobs={[{ id: '4', endpoint_name: 'Test Job', status: 'STATUS_06_EXPORTED', created_at: '2025-01-01T00:00:00Z', type: 'push', publishing_status: 'active' }]}
      />,
    );
    fireEvent.click(screen.getByLabelText('deactivate'));
