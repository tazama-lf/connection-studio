    ...
    <div className="max-w-6xl mx-auto p-6">
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-600">
          Extend the Tazama data model with custom fields specific to your use
          case. Extensions are tenant-isolated and become available in the
          mapping interface.
        </p>
      </div>
      ...
      <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
        ...
        <div className="text-blue-800 space-y-2">
          <p>
            • <strong>Custom Fields:</strong> Add new fields to existing Tazama
            collections
          </p>
          <p>
            • <strong>Field Types:</strong> Support for STRING, NUMBER, BOOLEAN,
            DATE, OBJECT, and ARRAY types
          </p>
          <p>
            • <strong>Validation:</strong> Set validation rules like min/max
            values, regex patterns
          </p>
          <p>
            • <strong>Mapping Integration:</strong> Extensions automatically
            appear in destination options
          </p>
          <p>
            • <strong>Tenant Isolation:</strong> Each tenant has their own set
            of extensions
          </p>
          <p>
            • <strong>Runtime Processing:</strong> Extensions are treated like
            native fields during data processing
          </p>
        </div>
      </div>
    </div>
