...
export const pullValidationSchema = yup.object({
    name: yup
        ...
        .test('no-reserved-names', 'Endpoint name cannot be a reserved API keyword', function (value) {
    ...
    targetTable: yup
        ...
        .test('no-reserved-words', 'Table name cannot be a reserved SQL keyword', function (value) {
        ...
        .when('sourceType', {
            ...
            then: (schema) => schema
                ...
                .test('valid-ip', 'Please enter a valid IP address', function (value) {
                    ...
                    if (invalidOctets.length > 0) {
                        return this.createError({ message: `Invalid IP address: octets cannot exceed 255` });
                    }
    ...
    port: yup
        ...
        .when('sourceType', {
            ...
            then: (schema) => schema
                ...
                .test('valid-port-range', 'Port must be between 1 and 65535', function (value) {
...
export const getAssociatedScheduleOptions = (schedules) => {
