...
export const JobList: React.FC<JobListProps> = (props) => {
  ...
  const handleTogglePublishingStatus = async (
    ...
    await togglePublishing(job, showSuccess, showError, () => {
      if (props.onRefresh) {
        props.onRefresh();
      }
    });
  ...
  const userRole = roles.publisher
    ? 'publisher'
    : roles.exporter
      ? 'exporter'
      : roles.approver
      ...
      },
      {
        ...
        renderCell: ({ row }) => (
          <ActionsWrapper>
                ...
                <Tooltip title="Pause">
                  <ActionIcon color="#f97316">
                    <Pause
                      size={16}
                      onClick={() => {
                        setShowPauseConfirmDialog({ open: true, job: row });
                      }}
                    />
                  </ActionIcon>
                </Tooltip>
            ...
            {roles.editor &&
              row.status === DATA_ENRICHMENT_JOB_STATUSES.ON_HOLD && (
                <Tooltip title="Resume">
                  <ActionIcon color="#22c55e">
                    <Play
                      size={16}
                      onClick={() => {
                        setShowResumeConfirmDialog({ open: true, job: row });
                      }}
                    />
                  </ActionIcon>
                </Tooltip>
  ...
  return (
    <>
      ...
      >
        <PauseDialogHeader>Pause Confirmation Required!</PauseDialogHeader>
      ...
      >
        <DialogHeader>Resume Confirmation Required!</DialogHeader>
      ...
      >
        <DialogHeader>Activate Confirmation Required!</DialogHeader>
      ...
      >
        <DialogHeader>Deactivate Confirmation Required!</DialogHeader>
