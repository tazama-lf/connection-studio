      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="mb-6">
          <div className="sm:flex sm:items-center sm:justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Dynamic Endpoint Monitoring Service</h1>
              <p className="mt-1 text-sm text-gray-600">
                Review and publish approved Dynamic Endpoint Monitoring System configurations
              </p>
            </div>
          </div>
