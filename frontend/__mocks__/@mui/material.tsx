...
export const Button = ({ children, onClick, disabled, variant, ...props }: any) => (
...
export const Dialog = ({ children, open, onClose, ...props }: any) => (
  open ? <div data-testid="mui-dialog" role="dialog" {...props}>{children}</div> : null
);
...
export const Alert = React.forwardRef(({ children, severity, ...props }: any, ref: any) => (
...
export const Radio = ({ checked, onChange, value, ...props }: any) => (
  <input type="radio" checked={checked} onChange={onChange} value={value} {...props} />
);
...
export const Autocomplete = ({ options, renderInput, onChange, value, ...props }: any) => (
...
export const ListItemText = ({ primary, secondary, ...props }: any) => (
  <div {...props}><span>{primary}</span>{secondary && <span>{secondary}</span>}</div>
);

export const ListItemButton = ({ children, onClick, selected, ...props }: any) => (
  <div role="button" onClick={onClick} data-selected={selected} {...props}>{children}</div>
);
...
export const Popover = ({ children, anchorEl, open, onClose, ...props }: any) => (
  open ? <div {...props}>{children}</div> : null
);
...
export const Avatar = ({ src, alt, children, ...props }: any) => (
  <div role="img" aria-label={alt} {...props}>{children || alt?.[0]}</div>
);

export const Badge = ({ children, badgeContent, ...props }: any) => (
  <span {...props}>{children}{badgeContent}</span>
);
...
export const useTheme = () => ({
  ...
  breakpoints: { up: () => '@media (min-width: 0px)', down: () => '@media (max-width: 9999px)', values: { xs: 0, sm: 600, md: 900, lg: 1200, xl: 1536 } },
  zIndex: { modal: 1300, tooltip: 1500 },
  typography: { h1: {}, h2: {}, h3: {}, h4: {}, h5: {}, h6: {}, body1: {}, body2: {}, subtitle1: {}, subtitle2: {}, caption: {}, button: {} },
  shape: { borderRadius: 4 },
  mixins: { toolbar: { minHeight: 56 } },
  shadows: Array(25).fill('none'),
  transitions: { create: () => 'all 300ms ease', easing: { easeInOut: 'cubic-bezier(0.4, 0, 0.2, 1)' }, duration: { shortest: 150, shorter: 200, short: 250, standard: 300 } },
  components: {},
});
...
export const SvgIcon = ({ children, ...props }: any) => <svg {...props}>{children}</svg>;
export const Skeleton = ({ variant, width, height, ...props }: any) => <div {...props} />;
export const Stepper = ({ children, activeStep, ...props }: any) => <div {...props}>{children}</div>;
...
export const StepContent = ({ children, ...props }: any) => <div {...props}>{children}</div>;
export const Popper = ({ children, open, ...props }: any) => open ? <div {...props}>{children}</div> : null;
export const ClickAwayListener = ({ children, onClickAway, ...props }: any) => <div {...props}>{children}</div>;
export const Grow = ({ children, in: inProp, ...props }: any) => <>{children}</>;
export const Fade = ({ children, in: inProp, ...props }: any) => <>{children}</>;
export const Zoom = ({ children, in: inProp, ...props }: any) => <>{children}</>;
export const Slide = ({ children, in: inProp, ...props }: any) => <>{children}</>;
export const Modal = ({ children, open, onClose, ...props }: any) => open ? <div role="dialog" {...props}>{children}</div> : null;
export const Drawer = ({ children, open, onClose, anchor, ...props }: any) => open ? <div {...props}>{children}</div> : null;
export const AppBar = ({ children, position, ...props }: any) => <header {...props}>{children}</header>;
export const Toolbar = ({ children, ...props }: any) => <div {...props}>{children}</div>;
...
export const CardHeader = ({ title, subheader, action, ...props }: any) => <div {...props}><div>{title}</div><div>{subheader}</div><div>{action}</div></div>;
export const CardMedia = ({ image, alt, ...props }: any) => <img src={image} alt={alt} {...props} />;
export const Accordion = ({ children, expanded, onChange, ...props }: any) => <div {...props}>{children}</div>;
export const AccordionSummary = ({ children, expandIcon, ...props }: any) => <div {...props}>{children}</div>;
export const AccordionDetails = ({ children, ...props }: any) => <div {...props}>{children}</div>;
export const ToggleButton = ({ children, value, selected, onChange, ...props }: any) => <button {...props}>{children}</button>;
export const ToggleButtonGroup = ({ children, value, exclusive, onChange, ...props }: any) => <div {...props}>{children}</div>;
export const Rating = ({ value, onChange, ...props }: any) => <div {...props} />;
export const Slider = ({ value, onChange, min, max, step, ...props }: any) => <input type="range" value={value} onChange={onChange} min={min} max={max} step={step} {...props} />;
export const SpeedDial = ({ children, ariaLabel, ...props }: any) => <div aria-label={ariaLabel} {...props}>{children}</div>;
export const SpeedDialAction = ({ tooltipTitle, icon, onClick, ...props }: any) => <button onClick={onClick} aria-label={tooltipTitle} {...props}>{icon}</button>;
export const SpeedDialIcon = ({ icon, openIcon, ...props }: any) => <span {...props}>{icon}</span>;
export const Fab = ({ children, onClick, ...props }: any) => <button onClick={onClick} {...props}>{children}</button>;
export const ButtonGroup = ({ children, ...props }: any) => <div {...props}>{children}</div>;
export const Breadcrumbs = ({ children, ...props }: any) => <nav aria-label="breadcrumb" {...props}><ol>{children}</ol></nav>;
export const Link = ({ children, href, ...props }: any) => <a href={href} {...props}>{children}</a>;
export const ImageList = ({ children, ...props }: any) => <ul {...props}>{children}</ul>;
export const ImageListItem = ({ children, ...props }: any) => <li {...props}>{children}</li>;
export const Pagination = ({ count, page, onChange, ...props }: any) => <nav {...props} />;
export const TablePagination = ({ count, page, rowsPerPage, onPageChange, ...props }: any) => <div {...props} />;
...
export const inputClasses = { root: 'root', input: 'input', focused: 'focused', disabled: 'disabled', error: 'error' };
export const buttonClasses = { root: 'root', disabled: 'disabled', contained: 'contained', outlined: 'outlined', text: 'text' };
export const chipClasses = { root: 'root', label: 'label', deleteIcon: 'deleteIcon' };
